...
After replacing the SD Card into the emulator, the emulator *must* be restarted, either via a Power cycle, or by pressing the run / reset button on the board, before any edits will be visible to the emulator
### Need for reset
