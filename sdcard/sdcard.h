...
#elif (defined(PICO_VGA_BOARD) || defined(PICO_DVI_BOARD) || defined(PICO_PICOMITEVGA_BOARD) || defined(PICO_OLIMEXPC_BOARD))
...
#else // PICO_LCDWS28_BOARD, PICO_LCDMAKER_BOARD, PICO_VGAMAKER_BOARD
